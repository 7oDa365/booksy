...
<div>
    <div class="container-fluid mt-5">
        <div class="row mb-5 text-center">
            ...
            <p class="lead px-3 text-secondary">
               Booksy is a young, passionate team dedicated to making quality books accessible for everyone. We offer a wide range of books for sale, and we can also print custom books just for you — whether it's a story, a project, or your own personal book. At Booksy, we focus on creativity, quality, and delivering every book with care.
            </p>
        </div>
    </div>
    ...
    <div class="container-fluid p-2 text-center">
        ...
        <p class="lead px-3 mb-5 text-secondary">
            We offer a variety of book categories to fit every reader— from novels and short stories to educational books and custom-printed projects. Whatever your interest, you’ll find a category that inspires you.
        </p>
    ...
    <div class="container-fluid mt-5 ">
        ...
        <p class="lead px-3 mb-5 text-secondary text-center">
            Discover our hand-picked books and stories, featuring popular titles and new arrivals you won’t want to miss.
        </p>
