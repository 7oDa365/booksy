                                        ...
                                        <div class="d-flex justify-content-between">
                                            @if($product->adjusted_price)
                                                <span class="text-secondary fw-bolder fs-4">
                                                    ...
                                                    <span style="font-size: 14px;">{{ session('currency', 'ُEGP') }}</span>
                                                </span>
                                            @else
            ...
            @else
                <div class="col-md-4">
                    <div class="fw-bolder" style="height: 50vh;">
                        Sorry! No Products Available. Comming Soon... متقلقش 
                    </div>
                </div>
            @endif
        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="filterSidebar">
        ...
        <div class="offcanvas-body">
            <form method="get" action="{{ route('product-list-categorized', ['name' => 'all']) }}">
                <!-- Publisher Filter -->
                <div class="mb-4">
                    <h6 class="fw-bold mb-3">Publisher</h6>
                    @foreach($filters['publisher'] as $publisher)
                        @if($publisher->publisher)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" 
                                    name="publisher[]" 
                                    value="{{ $publisher->publisher }}"
                                    {{ in_array($publisher->publisher, (array)request('publisher')) ? 'checked' : '' }}>
